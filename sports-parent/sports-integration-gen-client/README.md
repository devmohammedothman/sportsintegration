...
Strava API v3
- API version: 3.0.0
  - Build date: 2019-01-20T18:02:14.787+02:00
...
```groovy
compile "com.quasas.sports.gen.client:sports-integration-gen-client:0.0.1-SNAPSHOT"
```
...
* `target/sports-integration-gen-client-0.0.1-SNAPSHOT.jar`
* `target/lib/*.jar`
...
import com.quasas.sports.gen.client.invoker.*;
import com.quasas.sports.gen.client.invoker.auth.*;
import com.quasas.sports.gen.client.model.*;
...
public class ActivitiesApiExample {
    ...
    public static void main(String[] args) {
        ...
        ERRORUNKNOWN startDateLocal = new ERRORUNKNOWN(); // ERRORUNKNOWN | ISO 8601 formatted date time.
        ...
        ERRORUNKNOWN photoIds = new ERRORUNKNOWN(); // ERRORUNKNOWN | List of native photo ids to attach to the activity.
