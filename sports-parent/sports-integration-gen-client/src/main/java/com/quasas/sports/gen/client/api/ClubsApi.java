...
@Component("com.quasas.sports.gen.client.api.ClubsApi")
public class ClubsApi {
     ...
     */
    public List<SummaryActivity> getClubActivitiesById(Integer id, Integer page, Integer perPage) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<SummaryAthlete> getClubAdminsById(Integer id, Integer page, Integer perPage) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public DetailedClub getClubById(Integer id) throws RestClientException {
        Object postBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<SummaryAthlete> getClubMembersById(Integer id, Integer page, Integer perPage) throws RestClientException {
        Object postBody = null;
